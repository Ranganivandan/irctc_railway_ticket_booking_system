...
if (strcmp(loginusername,username) ==0 && strcmp(loginpass,pass)==0)
{
    ...
    printf("enters valid username or password");
    fclose(file);
    login();
...
switch (choicetrain)
{
case 1:ticketdetail(choicetrain);
    break;
case 2: ticketdetail(choicetrain);
break;
case 3:ticketdetail(choicetrain);
break;
case 4:ticketdetail(choicetrain);
break;
case 5:ticketdetail(choicetrain);
break;
case 6:ticketdetail(choicetrain);
break;


default:printf("enter valid input number\n ");
break;
}
...
default: printf("enter valid class\n");
    break;
}
